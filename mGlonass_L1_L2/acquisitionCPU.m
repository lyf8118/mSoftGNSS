...
for K = settings.acqSatelliteList
    ...
    acqResults.codePhase(K+8) = codePhaseMax;
    % Store GLRT statistic
    acqResults.peakMetric(K+8) = peakMax/secondPeak;
    ...
    if acqResults.peakMetric(K+8) > settings.acqThreshold
        ...
        caCode200ms = generateCAcode(0, settings.samplingFreq,samplesPerCode*200);
