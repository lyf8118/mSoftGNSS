...
for PRN = settings.acqSatelliteList 
    ...
    L3OcdCode2ms = [L3OcdCodesTable, zeros(1,samplesPerCode)]; 
    L3OcpCode2ms = [L3OcpCodesTable, zeros(1,samplesPerCode)];
    ...
    if acqResults.peakMetric(PRN) > settings.acqThreshold
        ...
        % L3Oc data and pilot codes
         L3OcdCode = generateL3OcdCode(PRN); 
        ...
        % Wipe off code and carrier from incoming signals
         basebandData = sig200ms .* L3OcdCode200ms .* localCarr200cm;
         basebandPilot = sig200ms .* L3OcpCode200ms .* localCarr200cm;
