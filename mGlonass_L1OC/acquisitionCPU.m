...
phasePoints = (0 : (samplesPerCode * 100-1)) * 2 * pi * ts;
...
for PRN = settings.acqSatelliteList
    ...
    localL1OCdCode = [L1OCdCodesTable, zeros(1,samplesPerCode)];
    ...
    if acqResults.peakMetric(PRN) > settings.acqThreshold
        ...
        sig200ms = longSignal(codePhaseMax:codePhaseMax + 100*samplesPerCode -1);
        ...
        samplesPer1ms = floor(samplesPerCode/2) * 200;
        ...
        L1OCpCodeFine = generateL1OCpBOCCode(PRN, settings);
        ...
        acqResults.L1OCpCodePhase(PRN) = tempPhase;
    else
