...
settings.fileName           ="../IF_Data_Set/GLO_L1OC_L1.bin";
...
settings.codeFreqBasis      = 0.5115e6 *2;              % [Hz]
settings.codeLength         = 1023 *2;
settings.L1OcpCodeLength    = 1023 *4 *2;
settings.L1OCFineFactor     = 2;
...
settings.trkMode                 = 0;   % 0 - Channel-serial tracking; 
...
settings.CNoInterval = 100;
%% L1OC carrier frequency ==========================================
settings.carrFreqBasis    = 1600.995e6;       %[Hz]
