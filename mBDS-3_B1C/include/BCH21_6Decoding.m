...
% in the BCNAV1 message. A total of 2^6 hypotheses are repeated to find
...
%       decodedBits  - Decoded message symbols for the BCH(21,6)
...
%CVS record:
%$Id: BCH21_6Decoding.m,v 1.1.2.5 2018/07/24 22:00:00 dpl Exp $

% Threshold for determining the success or fail of the decoding. This value
% can be reconfigured according to specific requirements
threshold = 20;

% Total 2^6 hypotheses of the original symbols before BCH(21,6) encoding 
hypoBits = zeros(2^6,6);

% Symbols after BCH(21,6) encoding for each hypothesis
encoded = zeros(1,21);

% Correlation values between the received data bits and the symbols after
