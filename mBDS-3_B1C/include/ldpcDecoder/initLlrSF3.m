function llrMatrix = initLlrSF3(receivedSignal, sigmaSquared)
% =========================================================================
% FUNCTION: initLlr
% DESCRIPTION:
...
% The tracking/navigation path represents a data bit 1 with positive prompt
% correlation and a data bit 0 with non-positive prompt correlation.
