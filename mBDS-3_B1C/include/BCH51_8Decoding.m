...
% in the BCNAV1 message. A total of 2^8 hypotheses are repeated to find
...
% Total 2^8 hypotheses of the original symbols before BCH(51,8) encoding 
hypoBits = zeros(2^8,8);

% Symbols after BCH(51,8) encoding for each hypothesis
encoded = zeros(1,51);
