...
%Function decodes ephemerides and TOW from the decoded B-CNAV1 bit stream.
%The array in navBitsBin must contain one 878-bit B-CNAV1 frame beginning
%with subframe 1.
%
%Function assumes BCH, LDPC, and CRC checks were completed before calling it.
%
...
if isempty(eph.flag)
    ...
    % IODC
    eph.IODC = bin2dec(subFra2Bit(22:31));
    % IODE
