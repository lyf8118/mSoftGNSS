function [CNo, PllDetector]= Calc_CNo_PLD_QMBOC(trackResults,settings,loopCnt)
...
%                           CNo(1) is for data channel, CNo(2) is for pilot
%                           channel, and CNo(2) is for the combined B1C signal
...
% ----------------------- C/N0 estimation for data channel -----------------
% Calculate Power
Z = I_P.^2 + Q_P.^2;
...
%% -------------------- C/N0 estimation for pilot channel ---------------
% Calculate Power
Z = I_P.^2 + Q_P.^2;
% Calculate the mean and variance of the Power
Zm = mean(Z);
