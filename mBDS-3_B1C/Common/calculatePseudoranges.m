function [pseudoranges,transmitTime,localTime,carrFreqPerSat] = ...
...
%       localTime       - local time in BDT at measurement time
...
% Transmission time of all channels at current measurement sample location
transmitTime = inf(1, settings.numberOfChannels);
carrFreqPerSat = inf(1, settings.numberOfChannels);
...
for channelNr = channelList
    ...
    % Transmission time (in seconds) at current measurement sample location
