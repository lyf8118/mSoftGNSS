...
%searches for B3I signals of all satellites, which are listed in field
...
% B3I code phases of detected signals
...
for PRN = settings.acqSatelliteList
    ...
    B3ICodes2ms = gpuArray([B3ICodesTable zeros(1,samplesPerCode)]);
    ...
    %--- Find 1 chip wide B3I code phase exclude range around the peak ----
    ...
    if acqResults.peakMetric(PRN) > settings.acqThreshold
        ...
        B3ICode = gpuArray(single(generateB3Icode(PRN)));
        ...
        % B3I code samples
        B3ICode200ms = B3ICode(rem(codeValueIndex, settings.codeLength) + 1);
        ...
        basebandSig = reshape(sig200ms .* B3ICode200ms, samplesPerCode, 200) ...
            .* localCarr1ms;
