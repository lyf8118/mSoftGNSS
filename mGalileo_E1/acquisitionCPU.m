...
for PRN = settings.acqSatelliteList
    ...
    if (codePhaseMax + 50*samplesPerCode -1) > length(longSignal)
    ...
    if acqResults.peakMetric(PRN) > settings.acqThreshold
        ...
        E1CPilotCode = generateE1Ccode(PRN);
        ...
        sig200ms = longSignal(codePhaseMax:codePhaseMax + 50*samplesPerCode -1);
        ...
        basebandSig = sig200ms .* E1CPilotCode200ms .* localCarr200cm;
