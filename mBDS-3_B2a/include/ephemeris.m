...
% Pi used in BDS orbit parameter scaling
...
switch MesType
    ...
    case 30 %--- It is Message Type 30 ------------------------------------
        ...
        % Inter-signal correction for the B2a data component
    ...
    case 33 %--- It is Message Type 33 ------------------------------------
        ...
        eph.WN_a   = bin2dec(navBitsBin(228:240));
        eph.t_oa   = bin2dec(navBitsBin(241:248))* 2^(12);
        % Other terms not decoded at the moment...
    ...
    case 34 %--- It is Message Type 34 ------------------------------------
        ...
        % PRN No.
        eph.PRN  = PRN;
        eph.SISAIoc      = bin2dec(navBitsBin(43:64));
        % Clock data reference time of Week
        ...
        % BDT-UTC ------------------------------------------
        eph.A_0UTC        = twosComp2dec(navBitsBin(144:159)) * 2^(-35);
        eph.A_1UTC        = twosComp2dec(navBitsBin(160:172)) * 2^(-51);
        eph.A_2UTC        = twosComp2dec(navBitsBin(173:179)) * 2^(-68);
        eph.delta_t_LS    = twosComp2dec(navBitsBin(180:187));
        eph.t_ot          = bin2dec(navBitsBin(188:203)) * 2^(4);
        eph.WN_ot         = bin2dec(navBitsBin(204:216));
        eph.WN_LSF        = bin2dec(navBitsBin(217:229));
        eph.DN            = bin2dec(navBitsBin(230:232));
        eph.delta_t_LSF   = twosComp2dec(navBitsBin(233:240));
        % Other terms not decoded at the moment...
