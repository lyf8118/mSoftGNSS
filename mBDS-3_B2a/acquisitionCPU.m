...
for PRN = settings.acqSatelliteList
    ...
    B2aDataCode2ms = [B2aDataTable, zeros(1,samplesPerCode)];
    B2aPilotCode2ms = [B2aPilotTable, zeros(1,samplesPerCode)];
    ...
    if acqResults.peakMetric(PRN) > settings.acqThreshold
        ...
        codeValueIndex = floor((ts * (0 : 200*samplesPerCode -1)) * ...
        ...
        basebandData = sig200ms .* B2aDataCode200ms .* localCarr200cm;
        basebandPilot = sig200ms .* B2aPilotCode200ms .* localCarr200cm;
