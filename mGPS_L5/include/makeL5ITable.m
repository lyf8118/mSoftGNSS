...
%Function generates L5I codes for the specified PRN based on the settings
...
%
%L5ICodesTable = makeL5ITable(settings, PRN)
%
%   Inputs:
...
%CVS record:
%$Id: makeL5ITable.m,v 1.1.2.6 2006/08/14 11:38:22 dpl Exp $
...
% number of samples per millisecond (because one L5I code period is one
% millisecond).
...
% chip array (L5I code) for the time instances of each sample.
