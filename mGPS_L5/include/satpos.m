...
for satNr = 1 : numOfSatellites
    ...
    % If message type 30 including 'T_GD' and 'ISC_L5I' is decoded, then
    ...
    % for PVT calculation. For more details on message contents please refer
    ...
    % ** This is different from GPS L5 CNAV **
...
%     satVelocity(1, satNr) = -yk*dOmega - (dyk1*cos(i) - ...
%                               zk*di) * sin(Omega) + dxk1*cos(Omega);
%     satVelocity(2, satNr) = xk*dOmega  + (dyk1*cos(i) - ...
