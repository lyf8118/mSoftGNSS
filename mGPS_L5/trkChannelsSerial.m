...
% Performs code and carrier tracking for L5C signals of all channels.
%
        ...
        for loopCnt =  1:codePeriods
            ...
            if settings.correlatorType == 0 % Using Matlab correlator
                correValues = corrMatlabSerialQPSK(settings, rawSignal, ...
                    L5CCodeTable, remCarrPhase, carrPhaseStep, remCodePhase,...
                    codePhaseStep);
