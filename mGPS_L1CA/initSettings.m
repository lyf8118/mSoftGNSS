...
settings.IF                 = 0e6;                  % [Hz] 14.58e6
settings.samplingFreq       = 30e6;                     % [Hz]  53e6
...
% up acquisition
settings.acqSatelliteList     = 1:32;   %[7 8 11 13 17 28 30];          %[PRN numbers]
...
% Enable/disable use of SIMD/GPU MEX to accelerate tracking
settings.correlatorType          = 1;   % 0 - Matlab correlator; 
                                        % 1 - SIMD correlator;
                                        % 2 - GPU correlator;
