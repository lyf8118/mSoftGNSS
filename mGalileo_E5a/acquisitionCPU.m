...
% E5a-I code phases of detected signals
...
for PRN = settings.acqSatelliteList
    ...
    E5aICode2ms = [E5aICodesTable, zeros(1,samplesPerCode)];
    E5aQCode2ms = [E5aQCodesTable, zeros(1,samplesPerCode)];
    ...
    if acqResults.peakMetric(PRN) > settings.acqThreshold
        ...
        basebandData = sig200ms .* E5aICode200ms .* localCarr200cm;
        basebandPilot = sig200ms .* E5aQCode200ms .* localCarr200cm;
