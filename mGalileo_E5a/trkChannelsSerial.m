...
% Performs code and carrier tracking for E5a signals of all channels.
%
...
codePeriods = settings.msToProcess;     % For BDS one E5a code is one ms
%--- DLL variables --------------------------------------------------------
% Summation interval
...
for channelNr = 1:settings.numberOfChannels
    ...
    if (channel(channelNr).PRN ~= 0)
        ...
        E5aCodeTable = [E5aICode E5aQcode];
        ...
        for loopCnt =  1:codePeriods
            ...
            if settings.correlatorType == 0 % Using Matlab correlator
                correValues = corrMatlabSerialQPSK(settings, rawSignal, ...
                    E5aCodeTable, remCarrPhase, carrPhaseStep, remCodePhase,...
                    codePhaseStep);
