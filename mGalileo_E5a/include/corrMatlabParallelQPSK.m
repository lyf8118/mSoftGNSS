function correValues = corrMatlabParallelQPSK(settings, rawSignal, E5aCodeTable, ...
...
for channelNr = 1:channelCnt
    ...
    codeLen = length(E5aCode)/2;
    E5aCodeD = E5aCode(1:codeLen);
    if (settings.pilotTRKflag == 1)
        E5aCodeP = E5aCode(1+codeLen:end);
    end
