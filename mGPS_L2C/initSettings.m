...
%% Processing settings ==============================================
% Number of milliseconds to be processed used 58000 + any transients (see
% below - in Nav parameters) to ensure nav subframes are provided
settings.msToProcess        = 58000;        %[ms]
...
settings.fileName           = "../IF_Data_Set/GPS_L2.bin";
...
% Define number of chips in a code period and code frequencies for 
% equivalent CM+CL code
settings.codeLength           = 10230 * 2;      % equivalent CM+CL code within 20ms 
settings.codeFreqBasis        = 0.5115e6 *2;    % [Hz] equivalent CM+CL code
settings.CLCodeLength         = 10230*75 *2;    % equivalent CM+CL code 
...
settings.acqSearchStep          = 1/0.02*2/3;     % [Hz]
...
settings.CNoInterval = 5;

%% GPS L2 carrier frequency =======================================
settings.carrFreqBasis    = 1227.60e6;       %[Hz]
