...
% Message types 10, 11, and any one clock message from types 30-37 are
% required to calculate satellite coordinates and the receiver position.
% Under the current broadcast sequence, these requisite data may span four
% 12-second message slots because other CNAV messages can be interleaved.
% Tracking may also start midway through the first message. Therefore, at
% least 60 seconds of tracked data are required to collect the four messages
