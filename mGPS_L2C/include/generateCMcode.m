...
% generateCMcode.m generates one GPS L2C CM return-zero code.
%
...
%
%   Outputs:
%       CMcode      - a vector containing the desired L2C CM code sequence
%                   (chips).  
...
%CVS record:
%$Id: generateCMcode.m,v 1.1.2.5 2016/08/23 22:00:00 dpl Exp $
