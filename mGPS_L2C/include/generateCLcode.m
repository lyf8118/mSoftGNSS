...
% generateCLcode.m generates one GPS L2C CL code.
%
...
%
%   Outputs:
%       CLcode      - a vector containing the desired L2C CL code sequence
%                   (chips).  
...
%CVS record:
%$Id: generateCLcode.m,v 1.1.2.5 2016/08/23 22:00:00 dpl Exp $
