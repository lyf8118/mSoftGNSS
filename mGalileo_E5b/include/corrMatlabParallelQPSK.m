function correValues = corrMatlabParallelQPSK(settings, rawSignal, E5bCodeTable, ...
...
for channelNr = 1:channelCnt
    ...
    codeLen = length(E5bCode)/2;
    E5bCodeD = E5bCode(1:codeLen);
    if (settings.pilotTRKflag == 1)
        E5bCodeP = E5bCode(1+codeLen:end);
    end
