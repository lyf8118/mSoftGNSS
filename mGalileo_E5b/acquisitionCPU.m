...
for PRN = settings.acqSatelliteList
    ...
    E5bICode2ms = [E5bICodesTable, zeros(1,samplesPerCode)];
    E5bQCode2ms = [E5bQCodesTable, zeros(1,samplesPerCode)];
    ...
    if acqResults.peakMetric(PRN) > settings.acqThreshold
        ...
        basebandData = sig200ms .* E5bICode200ms .* localCarr200cm;
        basebandPilot = sig200ms .* E5bQCode200ms .* localCarr200cm;
